...
const App = () => {
  ...
  const [myBurgerToppings, setMyBurger] = useState([])


function addToBurger (newTopping) {

  setMyBurger([...myBurgerToppings, newTopping])
  ...
  return (
    <main>
      ...
      <section>
        ...
        <BurgerStack myBurgerToppings={myBurgerToppings}/>
      </section>
    </main>
  );
};
